...
SELECT SUM(TotalPrice) AS TotalSumPrice, concat(c.FName, ' ',  c.Mname, ' ', c.LName) AS FML 
FROM Customers c
...
UNION
SELECT SUM(TotalPrice) AS TotalSumPrice, concat(e.FName, ' ', e.Mname, ' ', e.LName) AS FML
FROM Employees e
